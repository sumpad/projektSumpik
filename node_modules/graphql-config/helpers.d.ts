import { IGraphQLConfig, IGraphQLProject, IGraphQLProjects, GraphQLConfigResult } from './types';
...
export declare function getConfig(filepath: string): Promise<GraphQLConfigResult>;
export declare function findConfig(rootDir?: string): Promise<GraphQLConfigResult>;
