...
export declare function setCommandOptions(commandInstance: Command): import("commander").Command;
export declare function parseArgv(argv?: string[]): Command & YamlCliFlags;
export declare function createContext(cliFlags?: Command & YamlCliFlags): Promise<CodegenContext>;
export declare function updateContextWithCliFlags(context: CodegenContext, cliFlags: Command & YamlCliFlags): void;
export declare class CodegenContext {
    ...
    loadSchema(pointer: Types.Schema): Promise<import("graphql").GraphQLSchema>;
